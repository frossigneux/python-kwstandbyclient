...
class BaseClientManager(object):
    ...
    USER_AGENT = 'python-kwstandbyclient'

    def _get(self, url, response_key):
        """Sends get request to Kwstandby.

        :param url: URL to the wanted Kwstandby resource.
        :type url: str
    ...
    def _create(self, url, body, response_key):
        """Sends create request to Kwstandby.
    ...
    def _delete(self, url):
        """Sends delete request to Kwstandby.
    ...
    def _update(self, url, body, response_key=None):
        """Sends update request to Kwstandby.
