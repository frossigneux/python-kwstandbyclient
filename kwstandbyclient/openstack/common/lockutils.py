...
from kwstandbyclient.openstack.common import fileutils
from kwstandbyclient.openstack.common.gettextutils import _
from kwstandbyclient.openstack.common import log as logging
...
util_opts = [
    ...
    cfg.StrOpt('lock_path',
               default=os.environ.get("KWSTANDBYCLIENT_LOCK_PATH"),
...
def main(argv):
    ...
    os.environ["KWSTANDBYCLIENT_LOCK_PATH"] = lock_dir
    try:
